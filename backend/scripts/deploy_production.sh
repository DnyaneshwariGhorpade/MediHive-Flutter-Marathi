...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-env-vars "^@^DATABASE_URL=${DATABASE_URL}@MEDIHIVE_CLOUD=true@SECRET_KEY=${SECRET_KEY}@JWT_SECRET_KEY=${JWT_SECRET_KEY}@GOOGLE_CREDENTIALS_JSON=${GOOGLE_CREDENTIALS_JSON}@DRIVE_TOKEN_JSON=${DRIVE_TOKEN_JSON}@FIREBASE_SERVICE_ACCOUNT_JSON=${FIREBASE_SERVICE_ACCOUNT_JSON}@GOOGLE_SHEET_ID=1Nxj2Z5NE2m1eKxnojEZmpXTbRkvxmzcOKmuSza2a0mA@DRIVE_ROOT_FOLDER_ID=1Ogx1JHYBBSLTx4glL4-yhcGPLOdBN0GI@CLINIC_ID=CLI001@DB_POOL_MIN=0@DB_POOL_MAX=5@CONNECT_TIMEOUT=10@PYTHONUNBUFFERED=1"
